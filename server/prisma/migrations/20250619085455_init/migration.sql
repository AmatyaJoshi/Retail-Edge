...
-- AddForeignKey
ALTER TABLE "ExpenseTransactions" ADD CONSTRAINT "ExpenseTransactions_expenseId_fkey" FOREIGN KEY ("expenseId") REFERENCES "Expenses"("expenseId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExpensePayments" ADD CONSTRAINT "ExpensePayments_expenseId_fkey" FOREIGN KEY ("expenseId") REFERENCES "Expenses"("expenseId") ON DELETE RESTRICT ON UPDATE CASCADE;
