...
-- CreateIndex
CREATE UNIQUE INDEX "Users_appwriteId_key" ON "Users"("appwriteId");

-- CreateIndex
CREATE UNIQUE INDEX "Users_email_key" ON "Users"("email");

-- AddForeignKey
ALTER TABLE "Prescriptions" ADD CONSTRAINT "Prescriptions_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Customers"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
