...
exports.deleteAppwriteUserByEmail = deleteAppwriteUserByEmail;
...
const messaging = new node_appwrite_1.Messaging(client);
...
async function sendOtpEmail({ to, otp }) {
  ...
  `;
    try {
        ...
        await messaging.createEmail(node_appwrite_1.ID.unique(), // Unique ID for this email
 ...
 * @returns Boolean indicating success or failure
 */
async function deleteAppwriteUserByEmail(email) {
    try {
