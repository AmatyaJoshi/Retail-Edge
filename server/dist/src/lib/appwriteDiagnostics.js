...
exports.diagnoseAppwriteConfiguration = diagnoseAppwriteConfiguration;
exports.testEmailOTPFlow = testEmailOTPFlow;
const node_appwrite_1 = require("node-appwrite");
async function diagnoseAppwriteConfiguration() {
    ...
    try {
        ...
        try {
            ...
            const sessionToken = await account.createEmailToken(node_appwrite_1.ID.unique(), testEmail);
...
async function testEmailOTPFlow(email) {
