...
exports.deleteSale = exports.updateSale = exports.updateSaleStatus = exports.createSale = exports.getSaleById = exports.getSales = void 0;
...
const createSale = async (req, res) => {
    try {
        const { productId, customerId, quantity, unitPrice, totalAmount, paymentMethod } = req.body;
...
const updateSale = async (req, res) => {
    try {
        const { saleId } = req.params;
        const { productId, customerId, quantity, unitPrice, totalAmount, paymentMethod, status, timestamp } = req.body;
